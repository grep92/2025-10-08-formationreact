  ...
  return (
    <div className={style.MemeForm}>
      ...
      >
        ...
        <br />
        <input name="text" id="text" type="text" defaultValue={currentMeme.text} onChange={onStringInputChange}/>
        <br />
        <label htmlFor="x">
          <h2 style={{ display: "inline" }}>x :</h2>
        </label>
        <input className={style.smallNumber} name="x" id="x" type="number" defaultValue={currentMeme.x} onChange={onNumberInputChange}/>
        <label htmlFor="y">
          <h2 style={{ display: "inline" }}>y :</h2>
        </label>
        <input className={style.smallNumber} name="y" id="y" type="number" defaultValue={currentMeme.y} onChange={onNumberInputChange}/>
        <hr />
        <br />
        <h2>Decorations</h2>
        <label htmlFor="color">
        ...
        <input name="color" id="color" type="color" value={currentMeme.color} onChange={onStringInputChange}/>
        <br />
        ...
        />
        <br />
        <input name="underline" id="underline" type="checkbox" checked={currentMeme.underline} onChange={onCheckInputChange}/>
        &nbsp;
        ...
        &nbsp;
        <input name="italic" id="italic" type="checkbox" checked={currentMeme.italic} onChange={onCheckInputChange}/>
        <hr />
        <br />
